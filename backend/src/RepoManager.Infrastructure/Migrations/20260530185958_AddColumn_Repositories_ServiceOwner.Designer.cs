...
namespace RepoManager.Infrastructure.Migrations
{
    ...
    [Migration("20260530185958_AddColumn_Repositories_ServiceOwner")]
    partial class AddColumn_Repositories_ServiceOwner
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RepoManager.Domain.Entities.ReleaseRepository", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("FromCommitSha")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("ReleaseId", "RepositoryId")
                        .IsUnique();

                    b.ToTable("ReleaseRepositories");
                });
            ...
            modelBuilder.Entity("RepoManager.Domain.Entities.Release", b =>
                {
                    ...
                    b.Navigation("ReleaseRepositories");
